 ...
 *         title:
 *           type: string
 *           description: The title of the sleep place
 *           example: Le petit nid
 *         type:
 *           type: string
 *           description: The type of the sleep place
 ...
 *         city:
 *           type: string
 *           description: The city where the sleep place is located
 *           example: Paris
 *         zip:
 *           type: string
 *           description: The zip code of the city where the sleep place is located
 *           example: 75000
 *         country:
 *           type: string
 *           description: The country where the sleep place is located
 *           example: France
 *         nb_adults:
 *           type: integer
 *           format: int32
 *           description: The number of adults staying at the sleep place
 *           example: 2
 *         nb_children:
 *           type: integer
 *           format: int32
 *           description: The number of children staying at the sleep place
 *           example: 1
 *         avis:
 *           type: number
 *           description: The average rating of the sleep place
 *           example: 4.5
 *           format: float
 *         description:
 *           type: string
 *           description: The description of the sleep place
 *           example: Une chambre d'hôte très agréable
 *         service:
 *           type: string
 *           description: The service of the sleep place
 *           example: AIRBNB
 *         checkin:
 *           type: string
 *           format: date-time
 *           description: The checkin of the sleep place
 *           example: 2020-01-01T00:00:00.000Z
 *         checkout:
 *           type: string
 *           format: date-time
 *           description: The checkout of the sleep place
 *           example: 2020-01-02T00:00:00.000Z
 *         price:
 *           type: number
 *           description: The price of the sleep place
 *           format: float
 *           example: 100.00
 *     SleepWithId:
 *       allOf:
